...
data class Formacao(val nome: String, val conteudos: List<ConteudoEducacional>, val nivel: Nivel, val descricao: String) {
    ...
    fun listarMatriculados() {
        println(lerInscritos.joinToString(
            prefix = "Usuários matriculados na formação $nome:\n",
            separator = "\n") {
            it.nome
            }
        )
    ...
    fun listarConteudo() {
        println(conteudos.joinToString(
            prefix = "Os seguintes conteúdos fazem parte da formação $nome:\n",
            separator = "\n") {
